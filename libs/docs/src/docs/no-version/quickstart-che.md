...
1. Obtain access to Eclipse Che if you do not already have it, as an individual this can be done by setting up a [local instance of Eclipse Che](https://eclipse.dev/che/docs/stable/administration-guide/installing-che-locally/)
    ...
    [the corresponding guide](https://eclipse.dev/che/docs/stable/hosted-che/hosted-che/) in Eclipse Che documentation if this method is used
